...
@Component({
  selector: 'el-admin-cbc-fremantle',
  templateUrl: './admin-cbc-fremantle.component.html',
  styleUrls: ['./admin-cbc-fremantle.component.scss']
})
export class AdminCbcFremantleComponent implements OnInit {
